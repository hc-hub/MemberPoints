$(function(){
    ...
    $('#mytab').bootstrapTable({
    	...
    	columns:[
        	 { title: '全选', field: 'select', checkbox: true, width: 25, align: 'center', valign: 'middle' },//复选框
            { title: '店铺名称', field: 'S_Name', visible: false },
            { title: '登录姓名', field: 'U_LoginName', sortable: true },
            { title: '真实姓名', field: 'U_RealName', sortable: true },
            { title: '性别', field: 'U_Sex', },
            { title: '电话', field: 'U_Telephone' },
            { title: '角色', field: 'U_RoleName', sortable: true },
            {
                title: 'U_ID', field: 'U_ID', align: 'center',
                //列数据格式化
   ...
   function operateFormatter(value,row,index){
    ...
    function queryParams(params){
    	return{
    		...
    		U_LoginName: $('#search_name').val(),
    		U_Telephone: $('#search_tel').val()
    	}
    }
    //查询按钮事件
